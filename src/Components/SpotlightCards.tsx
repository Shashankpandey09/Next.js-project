...
const SpotlightCards:React.FC<Props> = ({imageUrl,teamName,collectionType,location}) => {
  ...
  <div className="translate-y-[-12px] relative">
    <div className="w-[20px] h-[20px] bg-gradient-to-r from-[#18282A] to-[#221A2C] absolute translate-x-[-12px] top-[-8px]  rounded-full"></div>
    <div className="w-[20px] h-[20px] bg-gradient-to-r from-[#18282A] to-[#221A2C]  absolute translate-x-[12px] right-0 top-[-8px] rounded-full"></div>
  <DottedLines/>
  </div>
    <div>
